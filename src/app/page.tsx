...
export default function Home() {
  return (
    <div>
      ...
      {/* Hero Section */}
      <main className="flex flex-col md:flex-row items-center justify-between pt-20 pb-6 md:px-20">
        <div className="flex-1 md:pr-10 text-center md:text-left">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            A educação com mais controle e transparência para você!
          </h1>
          <p className="text-lg mb-8">
            Simples. Rápido. Seguro. O futuro da presença escolar.
          </p>
          <div className="space-x-4">
            <button className="bg-indigo-500 text-white px-6 py-2 rounded hover:bg-indigo-600">
              Baixe agora
            </button>
            <button className="bg-transparent border border-indigo-500 text-indigo-500 px-6 py-2 rounded hover:bg-indigo-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-2xl font-bold mb-4 text-center">
              Check-in Rápido e Seguro com QR Code
            </h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-2xl font-bold mb-4 text-center">
              Relatórios e Histórico de Presença
            </h3>
            <p className="text-gray-600 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="text-center">
              <button className="bg-indigo-500 text-white px-6 py-2 rounded mt-8 hover:bg-indigo-600">
                Contratar Agora
              </button>
            </div>
          </div>
      ...
      <section className="bg-indigo-500 py-20 px-4">
        <div className="text-center">
          ...
          <form className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg">
            ...
            <div className="mb-6">
              <label htmlFor="message" className="block text-left text-gray-700 font-bold mb-2">
                Mensagem
              </label>
              <textarea
                id="message"
